-- =====================================================================
-- SwiftIPTV Panel - Estrutura do banco de dados
-- MySQL 8 / MariaDB
-- =====================================================================
-- Uso:
--   1. Crie o banco (ou ajuste o nome conforme config.php):
--        CREATE DATABASE swiftiptv CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
--   2. Importe este arquivo:
--        mysql -u root -p swiftiptv < schema.sql
--   3. (Recomendado) Acesse install/install.php uma vez para garantir o
--      operador admin com hash bcrypt válido para a sua versão do PHP.
-- =====================================================================

CREATE DATABASE IF NOT EXISTS swiftiptv
...
-- O hash abaixo é um bcrypt válido para "admin123".
-- IMPORTANTE: se o login falhar, abra install/install.php no navegador
-- (ele regenera este hash com a sua própria instalação do PHP).
...
-- (hash bcrypt válido para "teste123" — também recriável via install.php)
